...
<body>
 ...
 <section>
  <div class="container">
    <h6 style="text-align: center;">Click the camera icon below to upload more images for your <span style="color:  #ff0066;font-weight: bold;font-size: 20px;"><?=$buildingtitle; ?></span></h6>
    <h5 style="text-align: center;"><a href="javascript:void(0);" id="nomoreimages">I have no more images,lets skip this step.</a></h5>
 		<div style="display: flex;justify-content: center;align-items: center;">
           ...
           <div id="imageupAlert"></div>
              <input type="hidden" name="owner" value="<?=$buildingpsn; ?>" class="form-control">

              <input type="hidden" name="category" value="<?=$buildingcategory; ?>">
