...
$sn = $_GET['sn'];
$product = new Auth();
$productdetails = $product->fetchoneelectronics('Projector',$sn);
...
<meta name="viewport" content="width=device-width, initial-scale=1,shrink-to-fit=no">
  ...
  <title>Electronics | Projectors | <?=ucwords($row['name']) ?></title>
</head>
<body>
...
<section style="margin-bottom: 10px;">
  <div class="container">
    <div>
      <p style="text-align: center;">Electronics/Projectors/<span style="font-weight: bold;color:#ff0080;"><?=ucwords($row['name']) ?></span></p>
    </div>
