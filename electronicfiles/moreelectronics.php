...
<section>
   ...
   <div style="display: flex;margin-bottom: 10px;">
    ...
    <a href="phonedealers.php" style="width: 50%;background-color:   #e600e6;display: flex;justify-content: center;align-items: center;text-decoration: none;font-size: 20px;font-weight: bolder;" id="openshops">Dealers</a>
   </div>
  ...
  <section class="electronics">
    <h3 style="text-align: center;">More Electronics</h3>
    <div class="container">
  ...
  $(document).ready(function(){
    ...
    function fetchelectronics(){
      $.ajax({
        url: 'php/action.php',
        method: 'post',
        data: { action: 'fetchmoreelectronics' },
