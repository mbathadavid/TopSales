...
$sn = $_GET['sn'];
$product = new Auth();
$productdetails = $product->fetchoneelectronics('Printers',$sn);
...
<meta name="viewport" content="width=device-width, initial-scale=1,shrink-to-fit=no">
  ...
  <title>Electronics | Printers | <?=ucwords($row['name']) ?></title>
</head>
<body>
...
<section style="margin-bottom: 10px;">
  <div class="container">
    <div>
      <p style="text-align: center;">Electronics/Printers/<span style="font-weight: bold;color:#ff0080;"><?=ucwords($row['name']) ?></span></p>
    </div>
     ...
     ?>
        ...
        <?php else: ?>
            ...
            <div class="jumbotron">
              ...
              <h6>Maximum paper size      : <span style="font-weight: bold;color: #00cc66;"><?=$maxpapersize; ?></span></h6>
              <h6>Output Color            : <span style="font-weight: bold;color: #00cc66;"><?=$outputcolor; ?></span></h6>              
              <h6>Printing Speeed         : <span style="font-weight: bold;color: #00cc66;"><?=$pspeed; ?> Pages/minute</span></h6>
