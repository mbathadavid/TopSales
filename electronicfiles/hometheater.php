...
$sn = $_GET['sn'];
$product = new Auth();
$productdetails = $product->fetchoneelectronics('Audio',$sn);
...
<meta name="viewport" content="width=device-width, initial-scale=1,shrink-to-fit=no">
  ...
  <title>Electronics | Audio and Home Theatres | <?=ucwords($row['name']) ?></title>
</head>
<body>
...
<section style="margin-bottom: 10px;">
  <div class="container">
    <div>
      <p style="text-align: center;">Electronics/Audio and Home Theatres/<span style="font-weight: bold;color:#ff0080;"><?=ucwords($row['name']) ?></span></p>
    </div>
     ...
     ?>
        ...
        <?php else: ?>
            ...
            <div class="jumbotron">
              ...
              <h6>Type                    : <span style="font-weight: bold;color: #00cc66;"><?=$typeofaudio; ?></span></h6>             
