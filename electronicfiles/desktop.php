...
$sn = $_GET['sn'];
$product = new Auth();
$productdetails = $product->fetchoneelectronics('Desktops',$sn);
...
<section style="margin-bottom: 10px;">
	<div class="container">
    <div>
      <p style="text-align: center;">Electronics/Desktops/<span style="font-weight: bold;color:#ff0080;"><?=ucwords($row['name']) ?></span></p>
    </div>
