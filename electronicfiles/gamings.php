...
<section>
   ...
   <div style="display: flex;margin-bottom: 10px;">
    ...
    <a href="phonedealers.php" style="width: 50%;background-color:   #e600e6;display: flex;justify-content: center;align-items: center;text-decoration: none;font-size: 20px;font-weight: bolder;" id="openshops">Gaming Accessories Dealers</a>
   </div>
  ...
  <section class="electronics">
    <h3 style="text-align: center;">Gaming Accessories</h3>
    <div class="container">
