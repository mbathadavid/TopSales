...
$sn = $_GET['sn'];
$product = new Auth();
$productdetails = $product->fetchoneelectronics('Laptops',$sn);
...
<meta name="viewport" content="width=device-width, initial-scale=1,shrink-to-fit=no">
  ...
  <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	<title>Electronics | Desktops | <?=ucwords($row['NAME']) ?></title>
</head>
<body>
...
<section style="margin-bottom: 10px;">
	<div class="container">
    <div>
      <p style="text-align: center;">Electronics/Laptops/<span style="font-weight: bold;color:#ff0080;"><?=ucwords($row['NAME']) ?></span></p>
    </div>
     ...
     ?>
        ...
        <?php else: ?>
            ...
            <div class="jumbotron">
              ...
              <h6>Brand                   : <span style="font-weight: bold;color: #00cc66;"><?=$brand; ?></span></h6>
              <h6>Model                   : <span style="font-weight: bold;color: #00cc66;"><?=$model; ?></span></h6>
              <h6>RAM                     : <span style="font-weight: bold;color: #00cc66;"><?=$ram; ?> GB</span></h6>
              <h6>Storage                 : <span style="font-weight: bold;color: #00cc66;"><?=$storage; ?> GB</span></h6>
              <h6>Battery                 : <span style="font-weight: bold;color: #00cc66;"><?=$battery; ?> mAh</span></h6>
              <h6>Front Camera Resolution : <span style="font-weight: bold;color: #00cc66;"><?=$fcamera; ?> MP</span></h6>
              <h6>Rear Camera Resolution  : <span style="font-weight: bold;color: #00cc66;"><?=$rcamera; ?> MP</span></h6>
              <h6>Screen size             : <span style="font-weight: bold;color: #00cc66;"><?=$ssize; ?> inches</span></h6>
              <h6>Operating System        : <span style="font-weight: bold;color: #00cc66;"><?=$os; ?></span></h6>
  ...
  <div class="container">
    <div style="text-align: center;">
      ...
      <div style="border: solid 2px green;border-radius: 10px;margin-bottom: 5px;padding: 10px;">
        ...
        <h6>2.WhatsApp</h6>
        <a href="https://wa.me/+254<?=$businessphone?>?text=Hello%20<?=$businessowner?>, I saw your <?=$name?> which you posted in Thesupershop.Let us talk about it." class="btn btn-success"><i class="fas fa-whatsapp"></i>&nbsp; WhatsApp Seller</a>
        <h6>3.Email</h6>
