 ...
 <section>
    ...
    <!---Upload product form--->
 		<div style="display: flex;justify-content: center;align-items: center;margin-bottom: 10px;">
                  ...
                  <input type="number" name="productowner" class="form-control" value="<?=$csn; ?>">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
                  ...
                  <textarea cols="10" class="form-control" name="proddescription" style="width: 100%;height: 200px;background-color: #f8f8f8;resize: none;font-size: 16px;border:2px solid #ccc;color: #e60099;" required></textarea>
                </div>
              <div class="form-group">
            <input type="file" id="files" name="files[]" class="form-control"  required hidden>
            <label for="files" style="color: white;background-color:  #ff00bf;padding: 10px;font-size: 20px;font-weight: bold;width: 100%;"><i class="fas fa-file"></i>&nbsp; &nbsp;Click Me To Select Images</label>
            </div>      
          ...
          <!---Upload product form end--->
  </div>
    <div id="dvPreview" style="width: 100%;height: auto;margin-bottom: 20px;display:flex;padding: 20px;overflow-x: auto;"></div>
